...
| Evidence | `projects/test-workflow/artifacts/phase3b/appium-status.json`; `projects/test-workflow/artifacts/phase3b/environment-probe.json`; `projects/test-workflow/artifacts/phase3b/appium-page-source-initial.xml`; `projects/test-workflow/artifacts/phase3b/appium-server.log` |
