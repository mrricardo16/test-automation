...
Current Status: `READY_WITH_BLOCKER`
...
Forbidden: Product Source, Whitebox Internal, DLL/PDB, Source-assisted diagnosis. Do not write `READY_FOR_FULL_EXECUTION` while handoff integrity remains blocked.
