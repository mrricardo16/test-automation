...
const requiredFiles = [
  ...
  'scripts/platform/self-contained-html-report-exporter.mjs',
  'scripts/platform/self-contained-html-report-exporter.test.mjs',
  'scripts/platform/self-contained-html-report-validator.mjs',
  'scripts/platform/self-contained-html-report-validator.test.mjs',
  'projects/rsscomposer-blackbox/scripts/export-self-contained-html-report.mjs',
  'projects/rsscomposer-blackbox/scripts/validate-self-contained-html-report.mjs',
  'docs/generic-self-contained-html-report.css',
  'docs/generic-self-contained-html-report-template.md',
